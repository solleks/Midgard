...
//
//  LogicalViewAppDelegate.m
//

#import "LogicalViewAppDelegate.h"

#import "RootViewController.h"

@implementation LogicalViewAppDelegate
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"LogicalView" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"LogicalView.sqlite"];
